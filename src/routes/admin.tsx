...
const PRESERVED: any = import.meta.glob("/src/pages/admin/(_app|404|403).tsx", {
  eager: true,
});
const ROUTES: any = import.meta.glob("/src/pages/admin/**/[a-z[]*.tsx", {
  eager: true,
});

const preserved: any = Object.keys(PRESERVED).reduce((preserved, file) => {
  const key = file.replace(/\/src\/pages\/admin\/|\.tsx$/g, "");
