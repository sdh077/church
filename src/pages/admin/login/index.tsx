...
const Login = () => {
  ...
  const onSubmit = handleSubmit(async (values) => {
    ...
    if (values.username != "user" || values.password != "12341234") {
    ...
    <div className="flex flex-col items-center justify-center flex-1">
      <div className="gap-5 w-[400px] shadow-md p-10 rounded-lg">
        ...
        <div className="flex flex-col text-gray-500 my-2 py-2 text-sm border-y">
          ...
          <p>
            <span className="font-medium">Password:</span> 12341234
          </p>
        </div>
        <form onSubmit={onSubmit} className="flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-1">
            ...
            <input
              type="text"
              className="p-2 design-theme rounded"
              {...register("username")}
            />
          </div>
          ...
          <div className="flex flex-col gap-1">
            ...
            <input
              type="password"
              className="p-2 bg-design-theme rounded"
              {...register("password")}
            />
          </div>
